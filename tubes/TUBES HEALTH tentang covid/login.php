	...
	if (isset($_GET['pesan'])) {
		if ($_GET['pesan'] == "gagal") {
			echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
					Username/Password salah atau Anda belum Login
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="login/images/fight.png" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" action="cek_login.php" method="POST">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn">
							<input style="background-color: inherit;" type="submit" class="tombol_login" value="LOGIN">
						</button>
