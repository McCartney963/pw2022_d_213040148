    ...
    <section id="faq" class="faq section-bg">
        <div class="container">
            ...
            <ul class="faq-list">
                ...
                <li data-aos="fade-up" data-aos-delay="300">
                    <a data-toggle="collapse" href="#faq3_2" classl="collapsed">Manakah yang lebih rentan terinfeksi coronavirus: orang yang lebih tua atau orang yang lebih muda? <i class="icofont-simple-up"></i></a>
